	            ...
	            <div class="col-md-12">
	                <div class="box box-info">
	                    <div class="box-header with-border">
	                        <h3 class="box-title">添加咨询</h3>
	                    </div>
	                    <form id="form1" class="form-horizontal" action="/EasyBuyNews/add.do" method="post">
	                        <div class="box-body">
	                            <div class="form-group">
	                                <label for="txtALoginName" class="col-sm-2 control-label">标题：</label>
	                                <div class="col-sm-10">
	                                	<input type="text" id="txtALoginName" name="title" class="form-control" placeholder="请输入标题"/>
	                                </div>
	                            </div>
	                            <div class="form-group">
	                                <label for="txtAPassWord" class="col-sm-2 control-label">内容：</label>
	                                <div class="col-sm-10">
	                                	<input type="text" id="txtAPassWord" name="content" class="form-control" placeholder="请输入内容"/>
	                                </div>
	                            </div>
	                        </div>
