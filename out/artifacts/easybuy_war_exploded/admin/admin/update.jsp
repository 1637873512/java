	            ...
	            <div class="col-md-12">
	                <div class="box box-info">
	                    <div class="box-header with-border">
	                        <h3 class="box-title">管理管理员</h3>
	                    </div>
	                    <form id="form1" class="form-horizontal" method="post" action="/EasyBuyUser/update.do">
	                        <div class="box-body">
	                            <div class="form-group">
	                                ...
	                                <div class="col-sm-10">
	                                	<input type="text" id="txtALoginName" name="loginName" class="form-control" value="${user.loginName}" readonly/>
	                                </div>
	                            </div>
								<div class="form-group">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="text" id="txtAUsername" name="userName" class="form-control" value="${user.userName}"/>
										</div>
									</div>
							</div>
								<div class="form-group">
									<div class="form-group">
										...
										<div class="col-sm-10">
											<input type="radio"  name="sex" <c:if test="${user.sex == 1}">checked="checked"</c:if> value="1"/>男
											<input type="radio"  name="sex" <c:if test="${user.sex == 0}">checked="checked"</c:if> value="0"/>女
										</div>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-10">
										<input type="text" name="identityCode" class="form-control" value="${user.identityCode}"/>
									</div>
								</div>
								<div class="form-group">
								...
								<div class="form-group" id="a">
									...
									<div class="col-sm-10">
										...
										<c:if test="${user.type == 0}"> value="顾客" </c:if>
											   <c:if test="${user.type == 1}"> value="商家"</c:if>
										 readonly/>
									</div>
								</div>
	                        </div>
